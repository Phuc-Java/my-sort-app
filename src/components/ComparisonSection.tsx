      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h3 className="text-xl font-semibold mb-6 text-center">
            Biểu đồ so sánh hiệu năng (thời gian)
          </h3>
          <div className="h-64 flex items-end justify-center gap-8">
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="flex gap-2 items-end">
                <motion.div
                  ...
                  className="w-12 bg-primary/80 rounded-t overflow-hidden"
                >
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={isInView ? { opacity: 1 } : { opacity: 0 }}
                    transition={{ delay: 1.3 }}
                    className="text-xs text-center mt-1 text-primary-foreground"
                  >
                    10
                  </motion.div>
                </motion.div>
                <motion.div
                  initial={{ height: 0 }}
                  animate={isInView ? { height: "80px" } : { height: 0 }}
                  transition={{ duration: 0.8, delay: 0.9, ease: "easeOut" }}
                  className="w-12 bg-accent/80 rounded-t overflow-hidden"
                >
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={isInView ? { opacity: 1 } : { opacity: 0 }}
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="flex gap-2 items-end">
                <motion.div
                  initial={{ height: 0 }}
                  animate={isInView ? { height: "140px" } : { height: 0 }}
                ...
                <motion.div
                  initial={{ height: 0 }}
                  animate={isInView ? { height: "90px" } : { height: 0 }}
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="flex gap-2 items-end">
                <motion.div
                  initial={{ height: 0 }}
                  animate={isInView ? { height: "180px" } : { height: 0 }}
